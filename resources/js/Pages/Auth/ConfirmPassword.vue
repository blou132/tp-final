...
<template>
    <GuestLayout>
        <Head :title="t('auth.confirm_page_title')" />

        <header class="mb-6">
            <h1 class="text-xl font-bold text-slate-900">{{ t('auth.confirm_title') }}</h1>
            <p class="mt-1 text-sm text-slate-500">{{ t('auth.confirm_subtitle') }}</p>
        </header>
